 ...
 * @author cstuser
 */
public class MyRecordManageUI extends javax.swing.JFrame {
    ...
    RecordRenewUI renewUI;
    /**
     * Creates new form RecordManageUI
     */
    public MyRecordManageUI(User user) {
        initComponents();
        currentUser = user;
        GetRecordList();
    ...
    public void GetRecordList() { 
        ...
        records = OracleConnect.doSelectAllRecordsForSpeicalUser(currentUser.getUserName());
    }
    ...
    private void initComponents() {
        ...
        setTitle("Library System - My Records");
    ...
    private void updateBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBActionPerformed
        ...
        if (recordContent.length == 0) {
            ...
            try {
                ...
                Logger.getLogger(MyRecordManageUI.class.getName()).log(Level.SEVERE, null, ex);
            }
            renewUI = new RecordRenewUI(myRecord);
        }
